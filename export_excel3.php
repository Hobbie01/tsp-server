...
$input_from = $_GET["input_from"];
$input_to = $_GET["input_to"];
$datefrom = $input_from;
...
<head>
    ...
    <title>รายงานตั้งแต่วันที่ <?= $input_from; ?> ถึงวันที่ <?= $input_to; ?> (จำแนกตามภาควิชา)</title>
    <style>
    table,
    tr,
    td {
...
<body>
    <center>
        <h1>รายงานตั้งแต่วันที่ <?= $input_from; ?> ถึงวันที่ <?= $input_to; ?> (จำแนกตามภาควิชา)</h1>
    </center>
...
?>
        ...
        <tr>
            <td style="text-align: left;">
                ...
                * อัตราการติดเชื้อของแผลผ่าตัด (ต่อ 100
                แผลผ่าตัด)
        ...
        <tr>
            <td style="text-align: left;">
                ...
                * อัตราการติดเชื้อของแผลผ่าตัดสะอาด (ต่อ
                100 แผลผ่าตัด)
        ...
        <tr>
            <td style="text-align: left;">
                ...
                * อัตราการติดเชื้อของแผลผ่าตัดสะอาดปนเปื้อน
                (ต่อ
                100 แผลผ่าตัด)
        ...
        <tr>
            <td style="text-align: left;">
                ...
                * อัตราการติดเชื้อของแผลผ่าตัดปนเปื้อน (ต่อ
                100 แผลผ่าตัด)
        ...
        <tr>
            <td style="text-align: left;">* อัตราการติดเชื้อของระบบสืบพันธุ์
                (ต่อผู้ป่วยหลังคลอด 100 ราย)
            </td>
            <td>
