        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pb-2">
                    <form role="form" action="insert_forme2.php" method="post">
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="id_9">
                                                    <input type="text" name="d45" id="d45" value="" class="form-control"
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <div>
                                                <textarea name="d46" id="d46" style="width: 100%; height:100px;"></textarea>
                                            </div>
                                            </div>
                                        </div>
