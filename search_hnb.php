            ...
            <div class="col-12">
                <div class="card mb-4">
                    <div class="card-header pb-0">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <form id="form1" name="form1" class="form-inline" method="post" action="search_hnb.php">
                                    <div class="row">
                                        <div class="col-md-6">
                            ...
                            <div class="col-12">
                                <table style="width:500px;">
                                    ...
                                    <tr>
                                        ...
                                        <td align="center"><a href="formb1.php?PTUID=<?php echo $row['PTUID']; ?>&PTVUID=<?php echo $row['PTVUID']; ?>&PASID=<?php echo $row['PASID']; ?>">เลือก</a></td>
                                    </tr>
                                    <?php } ?>
                                </table>
