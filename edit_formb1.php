        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6> เพิ่มการวินิจฉัยการติดเชื้อในกระแสโลหิต</h6>
                </div>
                <div class="card-body pb-2">
                    <form role="form" action="edit_formb1_sql.php" method="post">
                        <div class="row">
                            <div class="col-4">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h6>ข้อมูลการใส่สายสวนหลอดเลือดส่วนกลาง central line</h6>
                                    <div class="form-status_yes">
                                        <input class="form-check-input" type="checkbox" value="1" id="Yes" name="Yes" <?php if($row['Yes'] == "1"){ 
                                            echo " checked"; 
                                            }else{
                                             echo "" ; 
                                            }?>>
                                        ...
                                        <div class="box">
                                            <div class="row">
                                                <div class="col-4 form-inline">
                                                    <label for="name"
                                                        class="formcontrol-label">St&nbsp;&nbsp;&nbsp;</label>
                                    ...
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value="1" id="No" name="No"<?php if($row['No'] == "1"){ 
                                            echo " checked"; 
                                            }else{
                                             echo "" ; 
                                            }?>>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mb-md-0 mb-4">
                                            <div
                                                ...
                                                <div class="form-a">
                                                    <h6 class="mb-2">เกณฑ์พิจารณาในการวินิจฉัย CLABSI</h6>
                                                    <div class="form-check">

                                                        <input class="form-check-input" type="radio" value="1"
                                                            id="check" name="check" <?php if($row['check'] == "1"){ 
                                            echo " checked"; 
                                            }else{
                                             echo "" ; 
                                            }?>>
                                                        <label class="form-check-label" for="check">
                                                            ผู้ป่วยใส่สายสวน central line > 2 วันปฏิทิน<br>
                                                            หรือหลังถอดสายสวน central lineไม่เกิน 2 วันปฏิทิน<br>
                                                            (วันที่ใส่หรือวันที่ถอดสายสวน central line นับเป็นวันที่
                                                            1)
                                                        </label>
                                                    </div>
                                        ...
                                        <div class="col-md-6">
                                            <div
                                                ...
                                                <div class="form-check">
                                                    <h6 class="mb-0">เกณฑ์พิจารณาในการวินิจฉัย BSI-non line</h6>
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="check">
                                                        ผู้ป่วยไม่ได้ใส่สายสวน central line <br>
                                                        หรือใส่สายสวน central line ไม่เกิน 2 วันปฏิทิน<br>
                                                        หรือหลังถอดสายสวนไปแล้ว > 2 วันปฏิทิน <br>
                                                        (วันที่ใส่หรือวันที่ถอดสายสวน central line นับเป็นวันที่ 1)
                                                    </label>
                                                </div>
                            ...
                            <div class="form-group text-center">
                                <input type="hidden" name="tableb1_id" value="<?= $row['tableb1_id'] ?>">
