...
$b = "select * from `tablec4` WHERE tablec1_id = '".$_GET['tablec1_id']."' Order By tablec1_id DESC Limit 1";
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pb-2">
                    <form role="form" action="edit_formc4_sql.php" method="post">
                            ...
                            <div class="card-body pt-4 p-3">
                                <div class="border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
                                    <div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    <label class="form-check-label" for="d2">Specimen</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    <label class="form-check-label" for="d7">Specimen</label>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    <label class="form-check-label" for="d12">Specimen</label>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="N" id="d16"
                                                        name="d16" <?php if($row_b['d16'] == "N"){ 
                                                        echo " checked"; 
                                                        }else{
                                                        echo "" ; 
                                                        }?>>
                                ...
                                <div class="border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="N" id="d27"
                                                        name="d27" <?php if($row_b['d27'] == "N"){ 
                                                        echo " checked"; 
                                                        }else{
                                                        echo "" ; 
                                                        }?>>
                                ...
                                <div class="border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="N" id="d33"
                                                        name="d33" <?php if($row_b['d33'] == "N"){ 
                                                        echo " checked"; 
                                                        }else{
                                                        echo "" ; 
                                                        }?>>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="hidden" name="tablec4_id" value="<?= $row_b['tablec4_id'] ?>">
                                            <input type="hidden" name="tablec1_id" id="tablec1_id"
