...
$a = "select * from `tablef` ORDER BY tablef_id DESC ";
...
<script>
function confirmDelete(tablef_id) { // ฟังก์ชันจะถูกเรียกถ้าผู้ใช้คลิกที่ link ลบ
    var ans = confirm("ต้องการลบข้อมูลฟอร์มนี้ " + tablef_id); // แสดงกล่องถามผู้ใช้
    if (ans == true) // ถ้าผู้ใช้กด OK จะเข้าเงื่อนไขนี้
        document.location = "delete_formf.php?tablef_id=" + tablef_id;
