...
$b = "select * from `tableb4` WHERE tableb1_id = '".$_GET['tableb1_id']."' Order By tableb1_id DESC Limit 1";
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6> เพิ่มการวินิจฉัยการติดเชื้อในกระแสโลหิต(ต่อ)</h6>
                    <h6>Bloodstream Infections</h6>
                </div>
                <div class="card-body pb-2">
                    <form role="form" action="edit_formb4_sql.php" method="post">
                            ...
                            <div class="card-body pt-4 p-3">
                                <div class="border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
                                    <div>
                                        ...
                                        <div class="row">
                                            <div class="col-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="hidden" value="1" id="d6"
                                        ...
                                        <div class="row">
                                            <div class="col-2">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="hidden" value="Y" id="d11"
                                                        name="d11" <?php if($row_b['d11'] == "Y"){ 
                                                        echo " checked"; 
                                                        }else{
                                                        echo "" ; 
                                                        }?>>
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="hidden" name="tableb4_id" value="<?= $row_b['tableb4_id'] ?>">
