...
$b = "select * from `tableb3`WHERE tableb1_id = '".$_GET['tableb1_id']."' ";
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pb-2">
                    <form role="form" action="edit_formb3_sql.php" method="post">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="c3">เชื้อที่พบไม่สัมพันธ์กับการติดเชื้อ
                                                ในตำแหน่งอื่น</label>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="c4">มีอาการข้อใดข้อหนึ่งดังต่อไปนี้ :
                                                ไข้ ( BT > 38 &#8451;) /หนาวสั่น / ความดันโลหิตต่่ำ</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="c5">พบเชื้อที่เป็นเชื้อประจำถิ่น
                                                หรือเชื้อ Common Commensal ขึ้นในเลือด &ge; 2 specimen</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label"
                                                for="c6">ไม่สัมพันธ์กับการติดเชื้อที่ตำแหน่งอื่นๆ ในร่างกาย</label>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="c8">มีอาการข้อใดข้อหนึ่งดังต่อไปนี้ :
                                                ไข้ ( BT > 38 &#8451;) /Hypothermia ( BT < 36 &#8451;) / Apnea /
                                                    Bradycardia</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="c9">มีผลตรวจเพาะเชื้อในเลือด 2 อย่าง
                                                ต่อไปนี้ : พบเชื้อที่เป็น Common Commensal &#8807; 2
                                                specimen</label>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label"
                                                for="c10">ไม่สัมพันธ์กับการติดเชื้อที่ตำแหน่งอื่นๆ ในร่างกาย</label>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-12">
                                <div class="form-group">
                                    <input type="hidden" name="tableb3_id" id="tableb3_id"
                                        value="<?php echo $row_b["tableb3_id"];?>">
