        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>เกณฑ์พิจารณาในการวินิจฉัยภาวะปอดอักเสบ (Pneumonia)</h6>
                </div>
                <div class="card-body pb-2">
                    <form role="form" action="insert_formc1.php" method="post">
                        <div class="row">
                            <div class="col-4">
                            ...
                            <div class="col-3">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="fname" id="fname" value="<?= $row['Forename']; ?>"
                                        placeholder="ชื่อ">
                                </div>
                            </div>
                            <div class="col-3">
                                ...
                                <div class="datepickers">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group date" id="id_0">
                                            <input type="text" name="date_in" id="date_in" value="" class="form-control"
                                ...
                                <div class="box">
                                    <div class="row">
                                        <div class="col-4 form-inline">
                                            ...
                                            <input class="form-control" type="text" name="st" id="st" placeholder="St">
                                        </div>
                                        <div class="col-4 form-inline">
                                        ...
                                        <div class="col-12-inline">
                                            <div class="form-group">
                                                <label for="name" class="formcontrol-label">Other
                                                    instrument&nbsp;&nbsp;&nbsp;</label>
                                                <input class="form-control" type="text" name="other_in" id="other_in"
                                            ...
                                            <div class="form-a">
                                                ...
                                                <div class="form-check">
                                                    ...
                                                    <label class="form-check-label" for="check">
                                                        ผู้ป่วยใส่เครื่องช่วยหายใจ > 2 วันปฏิทิน หรือหลังถอดเครื่่องช่วย<br>
