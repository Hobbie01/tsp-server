...
isset($_POST["tablec2_id"]) ? $tablec2_id = $_POST["tablec2_id"] : $tablec2_id = '';
...
$b_56 = $_POST['b56'];
$date=date_create($b_56);
$b56_1 = date_format($date,"Y-m-d H:i:s");
isset($_POST["b57"]) ? $b57 = $_POST["b57"] : $b57 = '';
isset($_POST["b58"]) ? $b58 = $_POST["b58"] : $b58 = '';

isset($_POST['b8']) ? $b8 = $_POST['b8'] : $b8 = '';
$b_8 = $_POST['b8'];
$date=date_create($b_8);
$b8_1 = date_format($date,"Y-m-d H:i:s");
isset($_POST['b9']) ? $b9 = $_POST['b9'] : $b9 = '';
$b_9 = $_POST['b9'];
...
isset($timestamp) ? $timestamp = date('Y-m-d H:i:s') : $timestamp = '';
    ...
    $b = "select * from `tablec2` WHERE tablec2_id = '".$tablec2_id."'";
    $bQuery = mysqli_query($objCon,$b);
    while($row_b = mysqli_fetch_array($bQuery)){
        if($row_b["tablec2_id"]==""){
            $strSQL = "insert into `tablec2` (`tablec2_id`, `b1`, `pname`, `fname`, `lname`, `b3`, `b4`, `b5`, `b6`, `b7`, `b8`, `b9`, `b10`, `b11`, `b12`, `b13`, `b14`, `b15`, `b16`, `b17`, `b18`, `b19`, `b20`, `b21`, `b22`, `b23`, `b24`, `b25`, `b26`, `b27`, `b28`, `b29`, `b30`, `b31`, `b32`, `b33`, `b34`, `b35`, `b36`, `b37`, `b38`, `b39`, `b40`, `b41`, `b42`, `b43`, `b44`, `b45`, `b46`, `b47`, `b48`, `b49`, `b50`, `b51`, `b52`, `b53`, `b54`, `b55`, `b56`, `b57`, `b58`, `tableb1_id`, `timestamp`) VALUES (NULL, '$b1', '$pname', '$fname', '$lname', '$b3', '$b4', '$b5', '$b6', '$b7', '$b8_1', '$b9_1', '$b10', '$b11', '$b12', '$b13', '$b14', '$b15', '$b16', '$b17', '$b18', '$b19', '$b20', '$b21', '$b22', '$b23', '$b24', '$b25', '$b26', '$b27', '$b28', '$b29', '$b30', '$b31', '$b32', '$b33', '$b34', '$b35', '$b36', '$b37', '$b38', '$b39', '$b40', '$b41', '$b42', '$b43', '$b44', '$b45', '$b46', '$b47', '$b48', '$b49', '$b50', '$b51', '$b52', '$b53', '$b54', '$b55', '$b56_1', '$b57', '$b58', '$tablec1_id', '$timestamp')";
            $objQuery = mysqli_query($objCon,$strSQL);
        }else{
            $strSQL = "update `tablec2` SET `b1` = '$b1', `pname` = '$pname', `fname` = '$fname', `lname` = '$lname', `b3` = '$b3', `b4` = '$b4', `b5` = '$b5', `b6` = '$b6', `b7` = '$b7', `b8` = '$b8', `b9` = '$b9_1', `b10` = '$b10', `b11` = '$b11', `b12` = '$b12', `b13` = '$b13', `b14` = '$b14', `b15` = '$b15', `b16` = '$b16', `b17` = '$b17', `b18` = '$b18', `b19` = '$b19', `b20` = '$b20', `b21` = '$b21', `b22` = '$b22', `b23` = '$b23', `b24` = '$b24', `b25` = '$b25', `b26` = '$b26', `b27` = '$b27', `b28` = '$b28', `b29` = '$b29', `b30` = '$b30', `b31` = '$b31', `b32` = '$b32', `b33` = '$b33', `b34` = '$b34', `b35` = '$b35', `b36` = '$b36', `b37` = '$b37', `b38` = '$b38', `b39` = '$b39', `b40` = '$b40', `b41` = '$b41', `b42` = '$b42', `b43` = '$b43', `b44` = '$b44', `b45` = '$b45', `b46` = '$b46', `b47` = '$b47', `b48` = '$b48', `b49` = '$b49', `b50` = '$b50', `b51` = '$b51', `b52` = '$b52', `b53` = '$b53', `b54` = '$b54', `b55` = '$b55', `b56` = '$b56_1', `b57` = '$b57', `b58` = '$b58' WHERE `tablec2`.`tablec2_id` = '$tablec2_id'";
            $objQuery = mysqli_query($objCon,$strSQL);
        }
