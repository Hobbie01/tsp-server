        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <h6>เพิ่มรายงานการติดเชื้อตำแหน่งอื่นๆ(ต่อ)</h6>
                </div>
                <div class="card-body pb-2">
<?php

$b = "select * from `tablee2` WHERE tablee2_id = '".$_GET['tablee2_id']."' Order By tablee1_id DESC Limit 1";
$bQuery = mysqli_query($objCon,$b);
while($row_b = mysqli_fetch_array($bQuery)){
    ?>
                    <form role="form" action="edit_forme2_sql.php" method="post">
                        ...
                        <div class="card">
                            <div class="card-body pt-4 p-3">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="d2" id="d2"
                                                        value="<?= $row_b['d2'] ?>" placeholder="Supecimen">
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="d7" id="d7"
                                                        value="<?= $row_b['d7'] ?>" placeholder="Supecimen">
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" name="d12" id="d12"
                                                        value="<?= $row_b['d12'] ?>" placeholder="Supecimen">
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="id_2">
                                                        <input type="text" name="d13" id="d13"
                                                            value="<?= $row_b['d13'] ?>" class="form-control"
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="id_3">
                                                        <input type="text" name="d19" id="d19"
                                                            value="<?= $row_b['d19'] ?>" class="form-control"
                                                            placeholder="MM/DD/YYYY hh:mm:ss" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="id_4">
                                                        <input type="text" name="d20" id="d20"
                                                            value="<?= $row_b['d20'] ?>" class="form-control"
                                                            placeholder="MM/DD/YYYY hh:mm:ss" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="id_5">
                                                        <input type="text" name="d22" id="d22"
                                                            value="<?= $row_b['d22'] ?>" class="form-control"
                                                            placeholder="MM/DD/YYYY hh:mm:ss" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="id_6">
                                                        <input type="text" name="d23" id="d23"
                                                            value="<?= $row_b['d23'] ?>" class="form-control"
                                                            placeholder="MM/DD/YYYY hh:mm:ss" />
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="id_7">
                                                        <input type="text" name="d25" id="d25"
                                                            value="<?= $row_b['d25'] ?>" class="form-control"
                                                            placeholder="MM/DD/YYYY hh:mm:ss" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group date" id="id_8">
                                                        <input type="text" name="d26" id="d26"
                                                            value="<?= $row_b['d26'] ?>" class="form-control"
                                                            placeholder="MM/DD/YYYY hh:mm:ss" />
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
                                    <div>
                                        <h6 class="mb-3 text-sm">Secondary bacteremia</h6>
                                        <div class="row">
                                            <div class="col-6">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" value="1" id="d34"
                                                        name="d34" <?php if($row_b['d34'] == "1"){ 
                                            echo " checked"; 
                                            }else{
                                             echo "" ; 
                                            }?>>
                                                    <label class="form-check-label" for="d34">Yes</label>
                                                </div>
                                            </div>
                                            <div class="col-6">
                                                <div class="form-check">
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="d35">No</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
                                    <div>
                                        <h6 class="mb-3 text-sm">Discharge status</h6>
                                        <div class="row">
                                            <div class="col-4">
                                                <div class="form-check">
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="d36">Dead</label>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-check">
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="d37">Active</label>
                                                </div>
                                            </div>
                                            <div class="col-4">
                                                <div class="form-check">
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="d38">Refer</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
                                    <div>
                                        <h6 class="mb-3 text-sm">Relation to death</h6>
                                        <div class="row">
                                            <div class="col-3">
                                                <div class="form-check">
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="d39">CA</label>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-check">
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="d40">CO</label>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-check">
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="d41">NR</label>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="form-check">
                                            ...
                                            echo " checked"; 
                                             ...
                                             echo "" ; 
                                                    ...
                                                    <label class="form-check-label" for="d42">U</label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="row">
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label class="form-check-label" for="d43">แพทย์ที่ให้คำปรึกษา</label>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                <label class="form-check-label" for="d44">ผู้รายงาน</label>
                                        ...
                                        <div class="col-4">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="id_9">
                                                    <input type="text" name="d45" id="d45" value="<?= $row_b['d45'] ?>"
                                                        class="form-control" placeholder="MM/DD/YYYY hh:mm:ss" />
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            <div class="form-group">
                                                <label class="form-check-label" for="d46">Note</label>
                                                <div>
                                                    <textarea name="d46" id="d46"
                                                        style="width: 100%; height:100px;"><?= $row_b['d46'] ?></textarea>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group text-center">
                                            <input type="hidden" name="tablee2_id" value="<?= $row_b['tablee2_id'] ?>">
                                            <input type="hidden" name="tablee1_id" id="tablee1_id" value="<?php echo $row_b["tablee1_id"];?>">
