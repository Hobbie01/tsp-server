...
isset($_POST["tableb4_id"]) ? $tableb4_id = $_POST["tableb4_id"] : $tableb4_id = '';
...
$strSQL = "update `tableb4` SET `tableb4_id` = '".$_POST["tableb4_id"]."', `d1` = '$d1', `d2` = '$d2', `d3` = '$d3_1', `d4` = '$d4', `d5` = '$d5', `d6` = '$d6', `d7` = '$d7', `d8` = '$d8_1', `d9` = '$d9', `d10` = '$d10', `d11` = '$d11', `d12` = '$d12', `d13` = '$d13_1', `d14` = '$d14', `d15` = '$d15', `d16` = '$d16', `d17` = '$d17', `d18` = '$d18', `d19` = '$d19_1', `d20` = '$d20_1', `d21` = '$d21', `d22` = '$d22_1', `d23` = '$d23_1', `d24` = '$d24', `d25` = '$d25_1', `d26` = '$d26_1', `d27` = '$d27', `d28` = '$d28', `d29` = '$d29', `d30` = '$d30', `d31` = '$d31', `d32` = '$d32', `d33` = '$d33', `d34` = '$d34', `d35` = '$d35', `d36` = '$d36_1', `timestamp` = '$timestamp' WHERE `tableb4_id` = '".$_POST["tableb4_id"]."'";
...
while ($row = mysqli_fetch_array($aQuery)){
    ...
    if($row["check"]=="1"){
        echo '<meta http-equiv="refresh" content="0; url=edit_formb2.php?tableb1_id='.$row["tableb1_id"].'">';
     }else{
