...
isset($_POST["tabled2_id"]) ? $tabled2_id = $_POST["tabled2_id"] : $tabled2_id = '';
...
isset($_POST["b15"]) ? $b15 = $_POST["b15"] : $b15 = '';
...
isset($_POST["b61"]) ? $b61 = $_POST["b61"] : $b61 = '';
isset($_POST["b62"]) ? $b62 = $_POST["b62"] : $b62 = '';
isset($_POST["b63"]) ? $b63 = $_POST["b63"] : $b63 = '';
isset($_POST["b64"]) ? $b64 = $_POST["b64"] : $b64 = '';
isset($_POST["b65"]) ? $b65 = $_POST["b65"] : $b65 = '';
isset($_POST['b7']) ? $b7 = $_POST['b7'] : $b7 = '';
$b_7 = $_POST['b7'];
$date=date_create($b_7);
$b7_1 = date_format($date,"Y-m-d H:i:s");
...
$b_26 = $_POST['b26'];
$date=date_create($b_26);
$b26_1 = date_format($date,"Y-m-d H:i:s");

$timestamp = date('Y-m-d H:i:s');
isset($timestamp) ? $timestamp = date('Y-m-d H:i:s') : $timestamp = '';

$b = "select * from `tabled2` WHERE tabled1_id = '".$tabled1_id."' Order By tabled1_id DESC Limit 1";
$bQuery = mysqli_query($objCon,$b);
while($row_b = mysqli_fetch_array($bQuery)){
    if($row_b["tabled2_id"]==""){
        $strSQL = "insert into `tabled2` (`tabled2_id`, `b1`, `pname`, `fname`, `lname`, `b2`, `b3`, `b4`, `b5`, `b6`, `b7`, `b8`, `b9`, `b10`, `b11`, `b12`, `b13`, `b14`, `b15`, `b16`, `b17`, `b18`, `b19`, `b20`, `b21`, `b22`, `b23`, `b24`, `b25`, `b26`, `b27`, `b28`, `b29`, `b30`, `b31`, `b32`, `b33`, `b34`, `b35`, `b36`, `b37`, `b38`, `b39`, `b40`, `b41`, `b42`, `b43`, `b44`, `b45`, `b46`, `b47`, `b48`, `b49`, `b50`, `b51`, `b52`, `b53`, `b54`, `b55`, `b56`, `b57`, `b58`, `b59`, `b60`, `b61`, `b62`, `b63`, `b64`, `b65`, `tabled1_id`, `timestamp`) VALUES (NULL, '$b1', '$pname', '$fname', '$lname', '$b2', '$b3', '$b4', '$b5', '$b6', '$b7_1', '$b8', '$b9_1', '$b10', '$b11', '$b12', '$b13', '$b14', '$b15', '$b16', '$b17', '$b18', '$b19', '$b20', '$b21', '$b22', '$b23', '$b24', '$b25', '$b26_1', '$b27', '$b28', '$b29', '$b30', '$b31', '$b32', '$b33', '$b34', '$b35', '$b36', '$b37', '$b38', '$b39', '$b40', '$b41', '$b42', '$b43', '$b44', '$b45', '$b46', '$b47', '$b48', '$b49', '$b50', '$b51', '$b52', '$b53', '$b54', '$b55', '$b56', '$b57', '$b58', '$b59', '$b60', '$b61', '$b62', '$b63', '$b64', '$b65', '$tabled1_id', '$timestamp')";
        $objQuery = mysqli_query($objCon,$strSQL);
    }else{
        $strSQL = "update `tabled2` SET `b1` = '$b1', `pname` = '$pname', `fname` = '$fname', `lname` = '$lname', `b2` = '$b2', `b3` = '$b3', `b4` = '$b4', `b5` = '$b5', `b6` = '$b6', `b7` = '$b7_1', `b8` = '$b8', `b9` = '$b9_1', `b10` = '$b10', `b11` = '$b11', `b12` = '$b12', `b13` = '$b13', `b14` = '$b14', `b15` = '$b15', `b16` = '$b16', `b17` = '$b17', `b18` = '$b18', `b19` = '$b19', `b20` = '$b20', `b21` = '$b21', `b22` = '$b22', `b23` = '$b23', `b24` = '$b24', `b25` = '$b25', `b26` = '$b26_1', `b27` = '$b27', `b28` = '$b28', `b29` = '$b29', `b30` = '$b30', `b31` = '$b31', `b32` = '$b32', `b33` = '$b33', `b34` = '$b34', `b35` = '$b35', `b36` = '$b36', `b37` = '$b37', `b38` = '$b38', `b39` = '$b39', `b40` = '$b40', `b41` = '$b41', `b42` = '$b42', `b43` = '$b43', `b44` = '$b44', `b45` = '$b45', `b46` = '$b46', `b47` = '$b47', `b48` = '$b48', `b49` = '$b49', `b50` = '$b50', `b51` = '$b51', `b52` = '$b52', `b53` = '$b53', `b54` = '$b54', `b55` = '$b55', `b56` = '$b56', `b57` = '$b57', `b58` = '$b58', `b59` = '$b59', `b60` = '$b60', `b61` = '$b61', `b62` = '$b62', `b63` = '$b63', `b64` = '$b64', `b65` = '$b65' WHERE `tabled2`.`tabled2_id` = '$tabled2_id'";
        $objQuery = mysqli_query($objCon,$strSQL);
    }
