...
$b = "select * from `tabled5` WHERE tabled1_id = '".$_GET['tabled1_id']."' Order By tabled1_id DESC Limit 1";
        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pb-2">
                    <form role="form" action="edit_formd5_sql.php" method="post">
                                ...
                                <div class="row mt-3">
                                    ...
                                    <div class="col-12">
                                        <div class="form-group text-center">
                                            <input type="hidden" name="tabled5_id" id="tabled5_id"
                                                value="<?php echo $row_b["tabled5_id"];?>">
