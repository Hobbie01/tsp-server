        ...
        <div class="col-12">
            <div class="card mb-4">
                ...
                <div class="card-body pb-2">
                    ...
                    <form role="form" action="insert_formb2.php" method="post">
                                            ...
                                            <div class="row">
                                                <div class="col-4">
                                                    <div class="form-group">
                                                        ...
                                                        <br><input class="typeahead" type="text" name="b1" id="b1" value="<?= $row['a1'] ?>">
                                                    </div>
                                                </div>
                                                <div class="col-2">
                                                    <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="b3" id="b3" value="<?= $row['HN'] ?>"
                                                            placeholder="HN">
                                                    </div>
                                                </div>
                                                <div class="col-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" name="b4" id="b4" value="<?= $row['age'] ?>"
                                                            placeholder="อายุ(ปี)">
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="input-group date" id="id_1">
                                                                <input type="text" name="b10" id="b10" value=""
                                                                    class="form-control"
                                                                    placeholder="MM/DD/YYYY hh:mm:ss" />
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-4">
                                                        ...
                                                        <input class="form-control" type="text" name="b15" id="b15"
                                                            placeholder="ระบุ">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="1"
                                                                id="b18" name="b18">
                                                            <label class="form-check-label" for="b18">TLC</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="1"
                                                                id="b66" name="b66">
                                                            <label class="form-check-label" for="ิb66">PICC</label>
                                                        </div>
                                                    </div>
                                                    <div class="col-2">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-check mb-3">
                                                            ...
                                                            <input class="form-control" type="text" name="b20" id="b20"
                                                        ...
                                                        <div class="col-12">
                                                            <div class="form-check mb-3">
                                                                <input class="form-check-input" type="checkbox"
                                                                    value="1" id="b21" name="b21">
                                                                <label class="form-check-label" for="b21">
                                                                    ส่งต่อจาก ร.พ. อื่น ระบุ
                                                                </label>
                                                                <label for="name"
                                                                    class="formcontrol-label">ลายละเอียด</label>
                                                                <input class="form-control" type="text" name="b22"
                                                            ...
                                                            <div class="col-12">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group date" id="id_2">
                                                                        <input type="text" id="b23" name="b23" value=""
                                                                            class="form-control"
                                                                            placeholder="MM/DD/YYYY hh:mm:ss" />
                                                                    </div>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-3">
                                                        <div class="form-check">
                                                            ...
                                                            <input class="form-control" type="text" name="b32" id="b32"
                                                                placeholder="ระบุ">
                                                        </div>
                                                    </div>
                                                    <div class="col-3">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            ...
                                                            <input class="form-control" type="text" id="b36" name="b36">
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-4">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" name="b37" id="b37"
                                                    ...
                                                    <div class="col-4">
                                                        <label for="name" class="formcontrol-label">เชื้อก่อโรค
                                                            3.</label>
                                                        <input class="form-control" type="text" id="b39" name="b39"
                                                            placeholder="เชื้อก่อโรค">
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            ...
                                                            <label for="name" class="formcontrol-label">ระบุ</label>
                                                            <input class="form-control" type="text" name="b41" id="b41"
                                                                placeholder="รายละเอียด">
                                                        </div>
                                                    </div>
                                                    <div class="col-6">
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        <div class="form-check">
                                                            ...
                                                            <label for="name" class="formcontrol-label">ระบุ</label>
                                                            <input class="form-control" type="text" name="b43" id="b43"
                                                                placeholder="รายละเอียด">
                                                            <br>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-6">
                                                        ...
                                                        <div class="form-check">
                                                            <input class="form-check-input" type="checkbox" value="1"
                                                                id="b45" name="b45">
                                                            <label class="form-check-label" for="b45">ใส่สายสวน central line มากกว่า 
                                                                7 วัน</label>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="border-0 p-4 mb-2 bg-gray-100 border-radius-lg">
                                                ...
                                                <div class="row">
                                                    <div class="col-12">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="b59"><h6>สรุปวิเคราะห์สาเหตุของการติดเชื้อ</h6></label>
