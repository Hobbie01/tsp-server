...
<head>
    ...
    <title>รายงานผู้ป่วยใส่อุปกรณ์พิเศษ</title>
<style>
table, tr, td {
...
<body>
    <center>
        <h1>รายงานผู้ป่วยใส่อุปกรณ์พิเศษ <?php echo $month."-".$year; ?></h1>
    </center>
    ...
    <tr>
        ...
        <td colspan="5">Procedure of Surgical
            Wound</td>
    </tr>
    <tr>
        <td>
...
?>
    ...
    <tr>
        ...
        <td rowspan="2">
            ...
            <?php echo array_sum($arr_aa); ?>
        </td>
        <td rowspan="2">

            <?php echo array_sum($arr_b); ?>
        </td>
        <td rowspan="2">

            <?php echo array_sum($arr_c); ?>
        </td>
        <td rowspan="2">

            <?php echo array_sum($arr_d); ?>
        </td>
        <td>

            <?php echo array_sum($arr_e); ?>
        </td>
        <td>

            <?php echo array_sum($arr_f); ?>
        </td>
        <td>

            <?php echo array_sum($arr_g); ?>
        </td>
        <td>

            <?php echo array_sum($arr_h); ?>
        </td>
        <td>

            <?php echo array_sum($arr_i); ?>
        </td>
        <td>

            <?php echo array_sum($arr_j); ?>
        </td>
        <td>

            <?php echo array_sum($arr_k); ?>
        </td>
        <td>

            <?php echo array_sum($arr_l); ?>
        </td>
        <td>

            <?php echo array_sum($arr_m); ?>
        </td>
    </tr>
