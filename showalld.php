...
<script>
function confirmDelete(tabled1_id) { // ฟังก์ชันจะถูกเรียกถ้าผู้ใช้คลิกที่ link ลบ
    var ans = confirm("ต้องการลบข้อมูลฟอร์มนี้ " + tabled1_id); // แสดงกล่องถามผู้ใช้
    if (ans == true) // ถ้าผู้ใช้กด OK จะเข้าเงื่อนไขนี้
        document.location = "delete_formd.php?tabled1_id=" + tabled1_id;
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-10">
                            <h3>เกณฑ์การวินิจฉัยการติดเชื้อที่ตำแหน่งผ่าตัดทั้งหมด</h3>
                        </div>
                        <div class="col-2">
                            <div class="float-right">
                                <a href="formd1.php" class="btn btn-primary btn-lg active me-2"
                                    role="button" aria-pressed="true">เพิ่มข้อมูล</a>
                                    <a href="search_hnd.php" class="btn btn-success" role="button"
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <?php 
                                $a = "select * from `tabled1` ORDER BY tabled1_id DESC ";
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-end">
                                        <a href="edit_formd1.php?tabled1_id=<?= $row["tabled1_id"] ?>"
                                            class="btn btn-outline-success px-3 py-2 me-2"><i
                                                class="fa fa-pencil"></i> แก้ไข
                                        </a>

                                        <a href="#" onclick='confirmDelete(<?= $row["tabled1_id"]?>)'
