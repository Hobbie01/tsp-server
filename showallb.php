...
<script>
function confirmDelete(tableb1_id) { // ฟังก์ชันจะถูกเรียกถ้าผู้ใช้คลิกที่ link ลบ
    var ans = confirm("ต้องการลบข้อมูลฟอร์มนี้ " + tableb1_id); // แสดงกล่องถามผู้ใช้
    if (ans == true) // ถ้าผู้ใช้กด OK จะเข้าเงื่อนไขนี้
        document.location = "delete_formb.php?tableb1_id=" + tableb1_id;
        ...
        <div class="col-12">
            <div class="card mb-4">
                <div class="card-header pb-0">
                    <div class="row">
                        <div class="col-10">
                            <h3>การวินิจฉัยการติดเชื้อในกระแสโลหิตทั้งหมด</h3>
                        </div>
                        <div class="col-2">
                            <div class="float-right">
                                <a href="formb1.php" class="btn btn-primary btn-lg active me-2"
                                    role="button" aria-pressed="true">เพิ่มข้อมูล</a>
                                    <a href="search_hnb.php" class="btn btn-success" role="button"
                    ...
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                $a = "select * from tableb1 order by tableb1_id desc";
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle text-end">
                                        <a href="edit_formb1.php?tableb1_id=<?= $row["tableb1_id"] ?>"
                                            class="btn btn-outline-success px-3 py-2 me-2"><i
                                                class="fa fa-pencil"></i> แก้ไข
                                        </a>

                                        <a href="#" onclick='confirmDelete(<?= $row["tableb1_id"]?>)'
